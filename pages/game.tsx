...
export default function Game() {
  ...
  const checkAnswer = (index: number, userAnswer: string) => {
    ...
    if (correctCount === totalCount) {
      ...
      localStorage.setItem('progress', JSON.stringify([...prevProgress, { round, correct: correctCount }]))
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-900 text-white flex flex-col items-center p-4 relative mb-6">
      ...
      {showCongrats && (
        ...
        >
          <div className="bg-white text-black rounded-2xl p-8 shadow-2xl text-center text-3xl font-bold animate-pulse mb-2">
