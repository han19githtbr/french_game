  ...
  return (
    <div className="min-h-screen bg-gray-900 from-slate-800 to-slate-900 text-white flex flex-col items-center p-4 relative mb-6">
                    ...
                    {replayIndex === currentConquest.plays.length - 1 && (
                      <div className="flex justify-center gap-3 mt-4 mb-6">
                        ...
                        <button
                          ...
                          className="flex items-center bg-transparent border-2 border-e-lightblue hover:bg-blue text-white font-bold py-1 px-3 rounded focus:outline-none focus:shadow-outline cursor-pointer text-sm"
                        >
      ...
      <motion.h1 
        ...
        className="text-3xl text-gray-300 font-thin mb-8 mt-92 text-center drop-shadow-md"
      >
      ...
      <div className="flex flex-col items-center gap-2 mb-6 mt-2">
        <div className="flex flex-wrap justify-center items-center gap-2">
          <span className="inline-flex items-center gap-2 rounded-full border border-violet-500/40 bg-slate-900/80 backdrop-blur-sm px-4 py-2 text-sm font-semibold text-violet-200">
            🎯 Dificuldade:
          </span>
          {[
      ...
      <div className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-indigo-900 to-purple-900 min-h-screen text-gray-100">
        ...
        <div className="mb-2 text-center">
          Rodada: <span className="font-semibold text-blue">{round}</span> | Acertos:{' '}
          <span className="font-semibold text-green">{correctAnswersCount} / {images.length}</span>
        </div>
