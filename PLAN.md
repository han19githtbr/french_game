...
Verification Plan
Manual Verification
Testar seleção de tema e carregamento de imagens (verificar se skeletons aparecem)
Verificar que erros de API mostram toast ao usuário
Testar tema claro e escuro em todas as páginas corrigidas
Conferir que results.tsx não usa mais bg-white text-black em modo escuro
Verificar que o claude-haiku model ID é válido na API Anthropic
Automated
